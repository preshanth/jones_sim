...
class TestJonesEquationGenerator:
    ...
    def test_single_effect_gains(self):
        ...
        expected = Matrix([[self.generator.g_xx, 0], [0, self.generator.g_yy]])
        assert result == expected
    ...
    def test_rl_delay_matrix_form(self):
        ...
        delta_theta = (
            2
            * pi
            * self.generator.delta_tau
            * (self.generator.nu - self.generator.nu_c)
        )
...
class TestEVLAMemoValidation:
    ...
    def test_rl_delay_cross_correlations(self):
        ...
        (2 * pi * self.generator.delta_tau * (self.generator.nu - self.generator.nu_c))
    ...
    def test_crosshand_phase_effects(self):
        ...
        expected = Matrix([[1, 0], [0, exp(I * self.generator.phi)]])
