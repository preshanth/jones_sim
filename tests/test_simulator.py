...
from jones_sim.effects import ElectronicGains, InstrumentalLeakage, ParallacticAngle
...
class TestJonesSimulator:
    ...
    def test_visibility_corruption_identity(self):
        ...
        corrupted = self.simulator.corrupt_visibilities(
            ideal_vis, freqs, times, ant1, ant2
        )
