...
try:
    from jones_sim.casa_interface import (
...
class TestFlagHandling:
    ...
    def test_flag_array_creation(self):
        ...
        n_edge_channels = int(edge_frac * params['n_channels'])
...
class TestSyntheticDataGeneration:
    ...
    def test_generate_realistic_visibility_grid(self):
        ...
        frequencies = np.linspace(params['freq_start'], params['freq_end'], params['n_channels'])
    ...
    def test_visibility_generation_with_realistic_source(self):
        ...
        required_keys = ['visibilities', 'flags', 'frequencies', 'times', 'antenna1', 'antenna2']
